...
def quiz_result(request, quiz_id):
    ...
    quiz_result = QuizResult.objects.create(quiz=quiz, user=request.user, score=score)
    ...
    for question in questions:
        ...
        # Store each question's result in StudentAnswer
    ...
    # Send email and render the result page
